...
vschema struct FeKelagerBend_t
{
	TYPEMETA( MNoScatter )
...
vschema struct FeNodeReverseOffset_t
{
...
//
vschema struct FeAxialEdgeBend_t
{
	TYPEMETA( MNoScatter )
...
vschema struct FeBandBendLimit_t 
{
	TYPEMETA( MNoScatter )
...
vschema struct FeRodConstraint_t
{
	TYPEMETA( MNoScatter )
...
vschema struct FeSimdRodConstraint_t
{
	TYPEMETA( MNoScatter )
...
vschema struct FeSimdNodeBase_t
{
	TYPEMETA( MNoScatter )
...
vschema struct FeNodeIntegrator_t
{
	TYPEMETA( MNoScatter )
...
vschema struct FeSpringIntegrator_t
{
	TYPEMETA( MNoScatter );
...
vschema struct FeSimdSpringIntegrator_t
{
	TYPEMETA( MNoScatter );
...
vschema struct ALIGN4 FeCtrlOsOffset_t // the rope offset from S1, a horrible hack in S1 I need to replicate in the new cloth so that some ropes behave the way they do in S1
{
	TYPEMETA( MNoScatter );
...
vschema struct FeCollisionSphere_t
{
	TYPEMETA( MNoScatter );
...
vschema struct FeCollisionPlane_t
{
	TYPEMETA( MNoScatter );
...
vschema struct FeWorldCollisionParams_t
{
	TYPEMETA( MNoScatter );
...
vschema struct FeTreeChildren_t
{
	TYPEMETA( MNoScatter );
...
vschema struct FeTaperedCapsuleRigid_t
{
	TYPEMETA( MNoScatter );
...
vschema struct FeSphereRigid_t
{
	TYPEMETA( MNoScatter );
...
vschema struct FeTaperedCapsuleStretch_t
{
	TYPEMETA( MNoScatter );
...
vschema class FourCovMatrices3
{
	TYPEMETA( MNoScatter );
...
vschema struct FeFitInfluence_t // helper struct
{
	TYPEMETA( MNoScatter );
...
vschema struct FeSimdFitMatrices_t
{
	TYPEMETA( MNoScatter );
