...
// Enum definitions
//-----------------------------------------------------------------------------
vschema enum TextureSpecificationFlags_t
{
...
vschema enum RenderMultisampleType_t
{
...
vschema struct TextureHeader_t : public TextureDesc_t
{
