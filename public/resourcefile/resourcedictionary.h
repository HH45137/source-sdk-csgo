...
// Type definitions
//-----------------------------------------------------------------------------
vschema typedef uint32 ResourceId_t;


//-----------------------------------------------------------------------------
// Enum definitions
//-----------------------------------------------------------------------------
vschema enum ResourceDictionaryVersion_t
{
	RESOURCE_DICT_VERSION = 1,// (explicit)
};

vschema enum ResourceCompressionType_t
{
	RESOURCE_COMPRESSION_NONE = 0,
};

vschema enum ResourceStandardIds_t
{
...
vschema struct ResourceDictionary_t
{
...
vschema struct ResourceDictionaryGroup_t
{
...
vschema struct ResourceDescription_t
{
	uint32           m_nId;
