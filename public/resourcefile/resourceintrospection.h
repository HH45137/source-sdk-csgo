...
// Enum definitions
//-----------------------------------------------------------------------------
vschema enum ResourceIntrospectionVersion_t
{
...
vschema enum ResourceFieldType_t
{
...
vschema enum ResourceIntrospectionMetadataType_t
{
...
vschema class CResourceFieldIntrospection
{
...
vschema enum ResourceStructFlags_t
{
	RESOURCE_STRUCT_HAS_VTABLE = 1,
};

vschema class CResourceStructIntrospection
{
...
vschema class CResourceEnumValueIntrospection
{
...
vschema class CResourceEnumIntrospection
{
...
vschema class CResourceTypedefIntrospection
{
...
vschema class CResourceIntrospectionMetadataElement
{
...
vschema class CResourceIntrospectionChildMetadata
{
	friend class CResourceIntrospectionMetadata;
private:
...
vschema class CResourceIntrospectionMetadata
{
public:
...
vschema class CResourceIntrospection
{
