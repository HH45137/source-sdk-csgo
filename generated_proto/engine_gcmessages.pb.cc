...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_engine_5fgcmessages_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_engine_5fgcmessages_2eproto = {
  false, false, 270, descriptor_table_protodef_engine_5fgcmessages_2eproto, "engine_gcmessages.proto", 
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    ...
    0, static_cast<size_t>(reinterpret_cast<char*>(&keyframe_interval_) -
    reinterpret_cast<char*>(&match_id_)) + sizeof(keyframe_interval_));
}
...
::PROTOBUF_NAMESPACE_ID::uint8* CEngineGotvSyncPacket::_InternalSerialize(
...
// @@protoc_insertion_point(class_specific_merge_from_start:CEngineGotvSyncPacket)
  ...
  if (cached_has_bits & 0x00000100u) {
    _internal_set_keyframe_interval(from._internal_keyframe_interval());
  }
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
...
void CEngineGotvSyncPacket::InternalSwap(CEngineGotvSyncPacket* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(CEngineGotvSyncPacket, keyframe_interval_)
      + sizeof(CEngineGotvSyncPacket::keyframe_interval_)
      - PROTOBUF_FIELD_OFFSET(CEngineGotvSyncPacket, match_id_)>(
